<!DOCTYPE html>
<html lang="fr"><head><meta charset="utf-8"><title>Paiement chapitres</title>
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body text-center">
            ...
            <form action="{{ route('paiement.store') }}" method="POST" id="pay-form-{{ $chapter->id }}">
              @csrf
              <input type="hidden" name="methode" id="methode-{{ $chapter->id }}" value="">
              <input type="hidden" name="numero"  id="numero-{{ $chapter->id }}" value="">
